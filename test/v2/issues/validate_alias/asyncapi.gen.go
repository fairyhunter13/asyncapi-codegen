// Package "validate_alias" provides primitives to interact with the AsyncAPI specification.
//
// Code generated by github.com/fairyhunter13/asyncapi-codegen version (devel) DO NOT EDIT.
...
type AuditSchema struct {
	Channel ChannelSchema `json:"channel,omitempty" validate:"omitempty,oneof=API0 API1 API2 API3 API4"`
}
